...
public class Filter {
    ...
    public static ArrayList<String> setFrequency(ArrayList<String> tokens) 
    {
	    	...
	    	ArrayList<Integer> TokenIntegerFrequency = new ArrayList<Integer>();
	    	for(ArrayList<String> sentence: sentences)
	    	{
	    		...
	    		{
	    			lhm.put(s, hm.get(s));
	    			TokenIntegerFrequency.add(hm.get(s));
	    		}
	    	}
	    	
	    Collections.sort(TokenIntegerFrequency);
     	ArrayList<String> TokenFrequency = new ArrayList<String>();
 	    for(int i = 0; i < TokenIntegerFrequency.size() -1; i++)
 	    {
	    		String numberAsString = String.format("%06d", TokenIntegerFrequency.get(i));
 	    	    TokenFrequency.add(numberAsString);
 	    }

...
--
-- Host: localhost:3306
-- Generation Time: Nov 04, 2017 at 12:14 AM
...
-- Database: `nlp_db`
--
CREATE DATABASE IF NOT EXISTS `nlp_db` DEFAULT CHARACTER SET utf8 COLLATE utf8_bin;
USE `nlp_db`;
...
(4, 'ching@gmail.com', '$2y$10$khPMD7VjuxpH2vGyPwiLeONet3yrABElw8VgvhFNxTRr2JOvic026', 'Boyd', 'Ching', 'subscriber', '2016-06-29 06:07:18 AM', 'approved', '/Users/jessgrunblatt/users-uaa/ching@gmail.com', NULL, NULL, NULL, 0, 0, 0, 0, '', 0, 0, NULL),
(8, 'byching@alaska.edu', '$2y$10$OIJlLw6m57OooQ3FVZjIr.Ldgb1euP6onfgO2amkRPNFYylr5fzNu', 'Boyd', 'Ching', 'subscriber', '2016-07-21 10:14:41 PM', 'approved', '/Users/jessgrunblatt/users-uaa/byching@alaska.edu', NULL, NULL, NULL, 0, 0, 0, 0, '', 0, 0, NULL),
(9, 'loyster1@alaska.edu', '$2y$10$N6yjQm0Bv4oAYXDg04c33.qNVFRuOFBP802OAqjbW6cwPVQWRa1o6', 'Levi', 'Oyster', 'subscriber', '2017-07-20 11:00:30 PM', 'approved', '/Users/jessgrunblatt/users-uaa/loyster1@alaska.edu', 0, 1, 40, 12, 0, 0, 0, '', 0, 0, NULL),
(11, 'motion411@gmail.com', '$2y$10$paOhccdordpY7bdKVchlYOKfbjUU7rYa4th3EZldVOp8pWUfD3T6O', 'Levi', 'Oyster', 'subscriber', '2016-10-15 04:04:30 AM', 'approved', '/Users/jessgrunblatt/users-uaa/motion411@gmail.com', NULL, NULL, NULL, 0, 0, 0, 0, '', 0, 0, NULL),
(15, 'peter@dadJokes.com', '$2y$10$xa01oz7Ljq8.hFKlh.OtO.9oDEJ.z7bJoO7FPEM5kZNGnsyv/X2h2', 'Peter', 'Peter', 'subscriber', '2017-08-23 04:56:51 AM', 'approved', '/Users/jessgrunblatt/users-uaa/peter@dadJokes.com/test', 1, 35, 5, 90, 2, 2, 10000, 'hybrid', 0, 0.4, 76),
(16, 'mcenek@alaska.edu', '$2y$10$oaTxT9Uey9UYL/yYxjunLujkDEEBNcfN5z4RpcXsdPXsfr1FcM2Im', 'Martin', 'Cenek', 'subscriber', '2017-11-03 11:40:59 PM', 'approved', '/Users/jessgrunblatt/users-uaa/mcenek@alaska.edu/AustraliaBroadcast', 1, 30, 10, 1, 1, 1, 500, 'hybrid', 0, 0.75, 73),
(33, 'Mc@Donald.com', '$2y$10$vN46vxjgQ5Brm4icLSY.OeQ2Lfr1d16k.zqQ5/QINHDGzVaXDDOl.', 'Ronald', 'McDonald', 'subscriber', '2017-05-22 05:33:16 AM', 'approved', '/Users/jessgrunblatt/users-uaa/Mc@Donald.com/klkl', 0, 80, 2, 91, 1, 1, 80, 'hybrid', 0, 0.4, 50),
(54, 'bob@bob.com', '$2y$10$p4aaRFVfPv9HwMfqAQZqOevVUGCRBcATfzRSvUbETqK4F.eGHqVge', 'bob', 'bob', 'subscriber', '2017-05-14 11:43:48 AM', 'approved', '/Users/jessgrunblatt/users-uaa/bob@bob.com/new', 0, 25, 5, 91, 1, 1, 1, 'hybrid', 0, 0.4, 44),
(55, 'newguya@safd.com', '$2y$10$DwHZx661nBvhRR7IyvwkhOduMUopcIcQnihqPqOgv3ec4iPnCUJEi', 'asdfag', 'gsd', 'subscriber', '2017-05-15 11:14:01 PM', 'approved', '/Users/jessgrunblatt/users-uaa/newguya@safd.com/project_one', 0, 25, 5, 91, 1, 1, 1, 'hybrid', 0, 0.4, 46),
(56, 'pak.eric@gmail.com1', '$2y$10$2FQTycRvkmlaT6Yxu/bNI.iMDztIXQcXTQ82ZtSNGTbLTkkaBLinK', 'eric', 'pak', 'subscriber', '2017-05-15 11:15:05 PM', 'approved', '/Users/jessgrunblatt/users-uaa/pak.eric@gmail.com1/project_one', 0, 25, 5, 91, 1, 1, 1, 'hybrid', 0, 0.4, 47),
(57, 'rowan.bulkow@gmail.com', '$2y$10$c0hPUuQHqifotnFFzBJiE..esMY17FRBAOqOL9ZOHBDFW6w0CzytG', 'rowan', 'bulkow', 'subscriber', '2017-08-01 06:22:45 AM', 'approved', '/Users/jessgrunblatt/users-uaa/rowan.bulkow@gmail.com/project_one', 0, 25, 5, 91, 1, 1, 1, 'hybrid', 0, 0.4, 63),
(58, 'james@lown.com', '$2y$10$5QsC6eooxcqA5/oxIpdQ6.BYNg.pn8BAWmXDxHO..9ZYR58OYFlfG', 'james', 'lown', 'subscriber', '2017-08-05 07:57:03 AM', 'approved', '/Users/jessgrunblatt/users-uaa/james@lown.com/project_one', 0, 25, 5, 91, 1, 1, 1, 'hybrid', 0, 0.4, 64),
(59, 'james@pak.com', '$2y$10$6mfogNMfbOvvbeO11iXb7eg7gp249IdsfxcWeajBziNemw8C1.aCe', 'James', 'Pak', 'subscriber', '2017-08-05 08:03:23 AM', 'approved', '/Users/jessgrunblatt/users-uaa/james@pak.com/project_one', 0, 25, 5, 91, 1, 1, 1, 'hybrid', 0, 0.4, 65),
(60, 'snap@snap.com', '$2y$10$Eo1P3vhn5AvgKn9gvFRcdevKDo7sE0y/pLCKbpcZdAfOKbggDPSAS', 'snap', 'snap', 'subscriber', '2017-08-07 10:49:48 AM', 'approved', '/Users/jessgrunblatt/users-uaa/snap@snap.com/poop', 0, 25, 5, 91, 1, 1, 1, 'hybrid', 0, 0.4, 67),
(61, 'jgrunbla@alaska.edu', '', 'Jess', 'Grunblatt', 'subscriber', '', 'pending', NULL, 0, 25, 5, 91, 1, 1, 1, 'hybrid', 0, 0.4, NULL),
(62, 'rbulkow2@alaska.edu', '$2y$10$uZ8xjk0fMjKfaDwKZPZEM.VUCFs2BgksIvf/NOwagYWLgJUFhbjXC', 'Rowan', 'Bulkow', 'subscriber', '2017-11-03 11:56:25 PM', 'approved', '/Users/jessgrunblatt/users-uaa/rbulkow2@alaska.edu/dummyTest', 1, 100, 1, 91, 1, 1, 1, 'hybrid', 0, 0.4, 80),
(63, 'drcenek@gmail.com', '$2y$10$401QxlwsXMNTemH1cYKw2uOp3ttLbGHWFsO9HXq.inETV3DYF5Li6', 'Martin', 'MartinC', 'subscriber', '2017-08-20 02:28:35 AM', 'approved', '/Users/jessgrunblatt/users-uaa/drcenek@gmail.com/project_one', 0, 25, 5, 91, 1, 1, 1, 'hybrid', 0, 0.4, 70),
(64, 'jess@gina.alaska.edu', '$2y$10$cKmCojCIjPxmQmROt91HWu1liOEmddleqA/MNNo5bDfhDIeXxbtaa', 'Jess', 'Grunblatt', 'subscriber', '2017-08-21 11:40:42 PM', 'approved', '/Users/jessgrunblatt/users-uaa/jess@gina.alaska.edu/project_one', 0, 25, 5, 91, 1, 1, 1, 'hybrid', 0, 0.4, 71),
(65, 'eric@test.com', '', 'eric', 'test', 'subscriber', '', 'pending', NULL, 0, 25, 5, 91, 1, 1, 1, 'hybrid', 0, 0.4, NULL),
(66, 'this@test.com', '', 'this', 'test', 'subscriber', '', 'pending', NULL, 0, 25, 5, 91, 1, 1, 1, 'hybrid', 0, 0.4, NULL),
(67, 'first@last.com', '', 'first', 'last', 'subscriber', '', 'pending', NULL, 0, 25, 5, 91, 1, 1, 1, 'hybrid', 0, 0.4, NULL),
(68, 'drodriguez9@alaska.edu', '$2y$10$v7fp1zZ1rg3puuE.hiXqpuK/80ptxvGotUkaKnK6aL9KmX.ww10p6', 'David', 'Rodriguez', 'subscriber', '2017-09-24 10:54:19 PM', 'approved', '/Users/jessgrunblatt/users-uaa/drodriguez9@alaska.edu/project_one', 0, 25, 5, 91, 1, 1, 1, 'hybrid', 0, 0.4, 77),
(69, 'josephf95@gmail.com', '$2y$10$fDCTw7Qtd2AHS8QcwXIlaehyNPv2tHQOlDpS1OaglHVG1R9op2Fem', 'Joe', 'Fiskeaux', 'subscriber', '2017-10-29 09:15:07 PM', 'approved', '/Users/jessgrunblatt/users-uaa/josephf95@gmail.com/project_one', 0, 25, 5, 91, 1, 1, 1, 'hybrid', 0, 0.4, 78),
(70, 'howyouvegrown@email.net', '', 'Mackenzie', 'Zaleska', 'subscriber', '', 'pending', NULL, 0, 25, 5, 91, 1, 1, 1, 'hybrid', 0, 0.4, NULL);
...
--
ALTER TABLE `projects`
  MODIFY `project_id` int(16) NOT NULL AUTO_INCREMENT,AUTO_INCREMENT=83;
--
